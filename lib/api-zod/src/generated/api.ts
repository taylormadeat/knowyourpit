 ...
 */
export const ListCookTemplatesResponseItem = zod.object({
  id: zod.number(),
  name: zod.string(),
  foodType: zod.string(),
  meatCategory: zod.string().nullable(),
...
export const ListCookTemplatesResponse = zod.array(
  ListCookTemplatesResponseItem,
);

/**
 * @summary Save a new cook template
 */
export const CreateCookTemplateBody = zod.object({
  name: zod.string(),
  foodType: zod.string(),
  meatCategory: zod.string().nullish(),
 ...
 */
export const UpdateCookTemplateParams = zod.object({
  id: zod.coerce.number(),
});

export const UpdateCookTemplateBody = zod.object({
  name: zod.string().nullish(),
});

export const UpdateCookTemplateResponse = zod.object({
  id: zod.number(),
  name: zod.string(),
  foodType: zod.string(),
  meatCategory: zod.string().nullable(),
 ...
 */
export const DeleteCookTemplateParams = zod.object({
  id: zod.coerce.number(),
});

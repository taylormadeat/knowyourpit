...
const s = StyleSheet.create({
  ...
  trendBarWrap: { flex: 1 },
  trendBarTrack: { height: 40, borderRadius: 3, overflow: "hidden", justifyContent: "flex-end" },
  trendBarFill: { borderRadius: 3, width: "100%" },
  radarCard: { borderWidth: 1, padding: 14, marginBottom: 20 },
  radarRow: { flexDirection: "row", alignItems: "flex-start", gap: 10, marginBottom: 12 },
  radarCat: { fontFamily: "Inter_700Bold", fontSize: 11, paddingTop: 2 },
  radarBarRow: { flexDirection: "row", alignItems: "center", gap: 6 },
  radarBarLabel: { fontFamily: "Inter_500Medium", fontSize: 10, width: 30 },
  radarBarTrack: { height: 6, borderRadius: 3, overflow: "hidden" },
  radarBarFill: { height: 6, borderRadius: 3 },
  radarBarPct: { fontFamily: "Inter_500Medium", fontSize: 10, width: 28, textAlign: "right" },
});

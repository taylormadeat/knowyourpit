          ...
          <View style={{ gap: 8 }}>
            ...
            {!effectivePro ? (
              <LockedFeatureCard
                ...
                teaser="Connect Fireboard base stations over your local network for live temps and auto PitMaster check-ins."
                icon="wifi"
              ...
              <View style={[s.lanPermCard, { backgroundColor: colors.card, borderColor: "#0EA5E940", borderRadius: colors.radius }]}>
                ...
                <Text style={[s.lanPermBody, { color: colors.mutedForeground }]}>
                  iOS will ask for permission to scan your local network. This lets knowyourpit automatically find Fireboard base stations on your WiFi — no IP address needed.
                </Text>
                ...
                {Platform.OS === "ios" && lanScanEnabled === true && mdnsAvailable && mdnsScanEmpty ? (
                  <View style={[s.emptyCard, { backgroundColor: "#EAB30812", borderColor: "#EAB30840", borderRadius: colors.radius }]}>
                    ...
                    <Text style={[s.emptySubText, { color: colors.mutedForeground }]}>
                      Make sure your Fireboard base station is powered on and connected to the same WiFi network as your phone.
                    </Text>
                  ...
                  <View style={[s.emptyCard, { backgroundColor: colors.card, borderColor: colors.border, borderRadius: colors.radius }]}>
                    ...
                    <Text style={[s.emptySubText, { color: colors.mutedForeground }]}>
                      {mdnsAvailable
                        ? "Auto-discovery (mDNS) is active — make sure your device is on the same WiFi network. Supported: Fireboard 2/Drive"
                        : "Supported: Fireboard 2/Drive"}
                    </Text>
                  </View>
                ) : (
                ...
                {!showAddManual ? (
                  ...
                  <View style={[s.emptyCard, { backgroundColor: colors.card, borderColor: colors.border, borderRadius: colors.radius, gap: 10 }]}>
                    ...
                    <View style={{ flexDirection: "row", gap: 6, flexWrap: "wrap" }}>
                      {(["fireboard"] as ManualDeviceType[]).map((type) => {
          ...
          <View style={{ gap: 8 }}>
            ...
            {!effectivePro ? (
              <LockedFeatureCard
                ...
                teaser="Pair Inkbird, Govee, and Weber iGrill probes via Bluetooth for live temperatures and automatic PitMaster coaching."
                icon="bluetooth"
                onPress={() => showPaywall({ trigger: "pro_required", featureName: "Smart Probe Integration" })}
              />
            ) : (
                    ...
                    <>
                      {!bleAvailabilityIssue && pairedDevices.length === 0 && !bleScanning && (
                        <View style={[s.emptyCard, { backgroundColor: colors.card, borderColor: colors.border, borderRadius: colors.radius }]}>
                          ...
                          <Text style={[s.emptySubText, { color: colors.mutedForeground }]}>
                            Tap "Scan for Devices" to discover nearby probes. Supported: Govee H5051/H5075, Weber iGrill 2/3/Mini, Inkbird IBT-series
                          </Text>
                        </View>
                      )}
...
const s = StyleSheet.create({
  container: { flex: 1 },
  sectionHeader: { fontSize: 12, fontFamily: "Inter_700Bold", letterSpacing: 0.8, textTransform: "uppercase" },
  scanButton: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 10, paddingVertical: 16, borderRadius: 12, borderWidth: 1,
  },
  scanButtonText: { fontSize: 16, fontFamily: "Inter_700Bold" },
  scanButtonSub: { fontSize: 12, fontFamily: "Inter_500Medium" },
  emptyCard: { borderWidth: 1, padding: 24, borderRadius: 12, alignItems: "center", gap: 10 },
  emptyText: { fontSize: 14, fontFamily: "Inter_600SemiBold", textAlign: "center" },
  emptySubText: { fontSize: 12, fontFamily: "Inter_500Medium", textAlign: "center", opacity: 0.8 },
  deviceCard: { borderWidth: 1, overflow: "hidden", borderRadius: 12 },
  deviceRow: { flexDirection: "row", alignItems: "center", gap: 14, padding: 18 },
  deviceIcon: { width: 44, height: 44, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  deviceName: { fontSize: 16, fontFamily: "Inter_700Bold", letterSpacing: -0.3 },
  deviceSub: { fontSize: 12, fontFamily: "Inter_500Medium", marginTop: 2 },
  connectedBadge: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: "#22c55e18", borderRadius: 99, paddingHorizontal: 10, paddingVertical: 5 },
  connectedText: { fontSize: 12, fontFamily: "Inter_700Bold", color: "#22c55e", textTransform: "uppercase", letterSpacing: 0.5 },
  deviceList: { borderTopWidth: 1, paddingHorizontal: 18, paddingVertical: 14, gap: 10 },
  probeRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  probeName: { flex: 1, fontSize: 14, fontFamily: "Inter_600SemiBold" },
  cookBadge: { backgroundColor: "#FF6B2B22", borderRadius: 99, paddingHorizontal: 10, paddingVertical: 4 },
  cookBadgeText: { fontSize: 11, fontFamily: "Inter_700Bold", color: "#FF6B2B", textTransform: "uppercase" },
  deviceActions: { borderTopWidth: 1, padding: 14 },
  unlinkBtn: { borderWidth: 1, borderRadius: 10, paddingVertical: 12, alignItems: "center" },
  unlinkText: { fontSize: 14, fontFamily: "Inter_700Bold", color: "#ef4444" },
  linkBtn: { margin: 16, marginTop: 0, borderRadius: 10, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 14 },
  linkBtnText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff" },
  linkForm: { borderTopWidth: 1, padding: 16, gap: 12 },
  linkFormLabel: { fontSize: 12, fontFamily: "Inter_500Medium", textTransform: "uppercase", letterSpacing: 0.5 },
  input: { borderWidth: 1, borderRadius: 10, padding: 14, fontSize: 15, fontFamily: "Inter_500Medium" },
  linkFormActions: { flexDirection: "row", gap: 12 },
  cancelBtn: { flex: 1, borderWidth: 1, borderRadius: 10, paddingVertical: 12, alignItems: "center" },
  cancelBtnText: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
  confirmLinkBtn: { flex: 1, borderRadius: 10, paddingVertical: 12, alignItems: "center", justifyContent: "center" },
  oauthHint: { fontSize: 12, fontFamily: "Inter_500Medium", lineHeight: 18 },
  oauthHintLink: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  rfxGuidance: { borderTopWidth: 1, padding: 16, gap: 10 },
  rfxTitle: { fontSize: 15, fontFamily: "Inter_700Bold" },
  rfxBody: { fontSize: 13, fontFamily: "Inter_500Medium", lineHeight: 20 },
  lanPermCard: { borderWidth: 1, padding: 20, gap: 14, borderRadius: 12 },
  lanPermIconRow: { flexDirection: "row", alignItems: "center", gap: 14 },
  lanPermIconWrap: { width: 48, height: 48, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  lanPermTitle: { fontSize: 16, fontFamily: "Inter_700Bold" },
  lanPermSub: { fontSize: 13, fontFamily: "Inter_500Medium", marginTop: 2 },
  lanPermBody: { fontSize: 14, fontFamily: "Inter_500Medium", lineHeight: 20 },
  lanPermBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 12, paddingVertical: 14, marginTop: 4 },
  lanPermBtnText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff" },
  openSettingsBtn: { marginTop: 6, flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "#EAB308", paddingHorizontal: 18, paddingVertical: 12, borderRadius: 10 },
  openSettingsBtnText: { fontSize: 14, fontFamily: "Inter_700Bold", color: "#fff" },
});

...
const s = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 18, fontFamily: "Inter_700Bold", marginTop: 4, letterSpacing: -0.3 },
  emptyText: { fontSize: 14, fontFamily: "Inter_500Medium", textAlign: "center", lineHeight: 22 },
  browseCta: { marginTop: 12, paddingHorizontal: 28, paddingVertical: 14, flexDirection: "row", alignItems: "center", gap: 10 },
  browseCtaText: { color: "#fff", fontFamily: "Inter_700Bold", fontSize: 15 },

  /* My grills flat cards */
  grillCardWrap: { borderWidth: 1, padding: 18 },
  grillCard: { flexDirection: "row", alignItems: "center", gap: 14 },
  grillCardTapTarget: { flex: 1, flexDirection: "row", alignItems: "center", gap: 16 },
  grillCardIcon: { width: 52, height: 52, borderRadius: 14, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  grillCardInfo: { flex: 1 },
  grillCardName: { fontSize: 16, fontFamily: "Inter_700Bold", marginBottom: 3, letterSpacing: -0.3 },
  grillCardBrand: { fontSize: 13, fontFamily: "Inter_500Medium", marginBottom: 6 },
  tagRow: { flexDirection: "row", gap: 6, flexWrap: "wrap" },
  tag: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  tagText: { fontSize: 11, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  grillStatRow: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 8, flexWrap: "wrap" },
  grillStatItem: { flexDirection: "row", alignItems: "center", gap: 5 },
  grillStatText: { fontSize: 12, fontFamily: "Inter_500Medium" },
  grillGradePill: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20, borderWidth: 1 },
  grillGradeText: { fontSize: 12, fontFamily: "Inter_700Bold" },
  grillGradeAvg: { fontSize: 12, fontFamily: "Inter_500Medium" },
  delBtn: { padding: 8 },
  ...
  searchWrap: { flexDirection: "row", alignItems: "center", gap: 12, margin: 16, borderWidth: 1, paddingHorizontal: 16, height: 48, borderRadius: 12 },
  searchInput: { flex: 1, fontSize: 15, fontFamily: "Inter_500Medium" },

  /* Catalog brand accordion */
  catBrandCard: { borderWidth: 1, overflow: "hidden", borderRadius: 12 },
  catBrandHeader: { flexDirection: "row", alignItems: "center", gap: 12, padding: 14 },
  catBrandInitial: { width: 36, height: 36, borderRadius: 10, alignItems: "center", justifyContent: "center" },
  catBrandInitialText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff" },
  catBrandLogo: { width: 36, height: 36, borderRadius: 10, alignItems: "center", justifyContent: "center", borderWidth: 1, padding: 4 },
  catBrandLogoImg: { width: "100%", height: "100%" },
  catBrandName: { fontSize: 15, fontFamily: "Inter_700Bold" },
  catBrandSub: { fontSize: 12, fontFamily: "Inter_500Medium", marginTop: 2 },

  catModelList: { borderTopWidth: 1 },
  catModelRow: { flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1 },
  catModelName: { fontSize: 14, fontFamily: "Inter_600SemiBold", marginBottom: 3 },
  catModelSub: { fontSize: 12, fontFamily: "Inter_500Medium" },
  addPill: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20 },
  addPillText: { fontSize: 13, fontFamily: "Inter_700Bold", color: "#fff" },

  /* Custom grill section */
  customDivider: { marginTop: 24, marginHorizontal: 16, paddingTop: 20, borderTopWidth: 1, alignItems: "center", gap: 12 },
  customDividerText: { fontSize: 13, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  customToggleBtn: { flexDirection: "row", alignItems: "center", gap: 8, borderWidth: 1, paddingHorizontal: 20, paddingVertical: 12 },
  customToggleText: { fontSize: 14, fontFamily: "Inter_700Bold" },

  customForm: { margin: 16, borderWidth: 1, padding: 20, gap: 4 },
  label: { fontSize: 12, fontFamily: "Inter_700Bold", marginTop: 14, marginBottom: 8, textTransform: "uppercase", letterSpacing: 0.5 },
  inputWrap: { borderWidth: 1, height: 48, justifyContent: "center", paddingHorizontal: 16 },
  ...
  saveBtn: { marginTop: 20, paddingVertical: 16, alignItems: "center" },
  saveBtnText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff" },
  helperText: { fontSize: 12, fontFamily: "Inter_500Medium", marginTop: -4, marginBottom: 6 },
  wifiToggle: { flexDirection: "row", alignItems: "center", gap: 12, borderWidth: 1, paddingHorizontal: 16, paddingVertical: 14, marginTop: 14 },
  wifiToggleText: { fontSize: 15, fontFamily: "Inter_600SemiBold" },

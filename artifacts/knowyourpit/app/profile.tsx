...
const s = StyleSheet.create({
  ...
  profileName: { fontSize: 22, fontFamily: "Inter_700Bold", letterSpacing: -0.4 },
  editBtn: { padding: 4 },
  profileEmail: { fontSize: 14, fontFamily: "Inter_500Medium" },
  memberSince: { fontSize: 11, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.8 },
  statsRow: { flexDirection: "row", gap: 12, paddingHorizontal: 16, paddingTop: 20 },
  statCard: { flex: 1, borderWidth: 1, borderRadius: 12, paddingVertical: 18, alignItems: "center", gap: 4 },
  statValue: { fontSize: 26, fontFamily: "Inter_700Bold" },
  statLabel: { fontSize: 11, fontFamily: "Inter_600SemiBold", textAlign: "center", textTransform: "uppercase", letterSpacing: 0.8 },
  infoSection: { margin: 16, marginBottom: 0, borderWidth: 1, borderRadius: 12, overflow: "hidden" },
  infoRow: {
    flexDirection: "row",
  ...
  infoLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  infoValue: { fontSize: 14, fontFamily: "Inter_500Medium", maxWidth: "60%", textAlign: "right" },
  sectionHeader: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  pillRow: { flexDirection: "row", gap: 8, paddingHorizontal: 16, paddingBottom: 12 },
  pill: { paddingHorizontal: 14, paddingVertical: 8, borderWidth: 1, borderRadius: 20 },
  pillText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  qualityCard: { marginHorizontal: 16, borderWidth: 1, borderRadius: 12, overflow: "hidden" },
  qualitySubtitle: { fontSize: 12, fontFamily: "Inter_500Medium", padding: 16, textAlign: "center", borderBottomWidth: 1, borderBottomColor: "rgba(150,150,150,0.2)" },
  qualityRow: { flexDirection: "row", justifyContent: "space-around" },
  qualityItem: { alignItems: "center", gap: 4, paddingVertical: 20, flex: 1, borderRightWidth: 1, borderRightColor: "rgba(150,150,150,0.2)" },
  qualityScoreRow: { flexDirection: "row", alignItems: "baseline", gap: 2 },
  qualityScore: { fontSize: 24, fontFamily: "Inter_700Bold" },
  qualityScoreMax: { fontSize: 12, fontFamily: "Inter_600SemiBold", paddingBottom: 3 },
  qualityLabel: { fontSize: 11, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  meatTypeSection: { paddingTop: 0 },
  meatTypeHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "rgba(150,150,150,0.05)", padding: 16, borderBottomWidth: 1, borderBottomColor: "rgba(150,150,150,0.1)" },
  meatTypeLabel: { fontSize: 15, fontFamily: "Inter_700Bold" },
  meatTypeCount: { fontSize: 12, fontFamily: "Inter_500Medium" },
  qualityItemCompact: { alignItems: "center", gap: 3, flex: 1, paddingVertical: 16, borderRightWidth: 1, borderRightColor: "rgba(150,150,150,0.2)" },
  qualityLabelCompact: { fontSize: 10, fontFamily: "Inter_700Bold", textTransform: "uppercase", letterSpacing: 0.8 },
  qualityScoreCompact: { fontSize: 20, fontFamily: "Inter_700Bold" },
  qualityScoreMaxCompact: { fontSize: 11, fontFamily: "Inter_600SemiBold", paddingBottom: 2 },
  overallRow: { borderBottomWidth: 1, padding: 16, gap: 4 },
  overallLabel: { fontSize: 11, fontFamily: "Inter_700Bold", textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 2 },
  overallScoreRow: { flexDirection: "row", alignItems: "baseline", gap: 4 },
  overallScore: { fontSize: 32, fontFamily: "Inter_700Bold" },
  overallScoreMax: { fontSize: 15, fontFamily: "Inter_600SemiBold", paddingBottom: 4 },
  // Modal
  ...
  nameInput: { borderWidth: 1, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, fontFamily: "Inter_500Medium" },

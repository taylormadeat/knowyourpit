...
const s = StyleSheet.create({
  ...
  heroName: { fontSize: 20, fontFamily: "Inter_700Bold", letterSpacing: -0.4 },
  heroBrand: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
  heroModel: { fontSize: 12, fontFamily: "Inter_500Medium" },

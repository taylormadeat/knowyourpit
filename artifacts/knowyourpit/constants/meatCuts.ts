...
export const MEAT_CUTS: BuiltinMeatCut[] = [
  ...
  { category: "Beef", name: "Porterhouse Steak", targetTempF: 130, cookTempF: 250, minsPerLb: 22, restMins: 12, cookMethod: "Reverse Sear", notes: "Large T-bone with a full tenderloin section; cook bone-side toward heat", avgPieceWeightLbs: 2.0, defaultSizeMode: "count", isIndividualCook: true },
  { category: "Beef", name: "T-Bone Steak", targetTempF: 130, cookTempF: 250, minsPerLb: 20, restMins: 10, cookMethod: "Reverse Sear", notes: "Strip + small tenderloin on the bone; position bone toward the hottest zone", avgPieceWeightLbs: 1.25, defaultSizeMode: "count", isIndividualCook: true },
  { category: "Beef", name: "London Broil (Top Round)", targetTempF: 135, cookTempF: 450, minsPerLb: 8, restMins: 10, cookMethod: "Direct Heat", notes: "Marinate 24h; sear hot and slice paper-thin across the grain", avgPieceWeightLbs: 2.5, defaultSizeMode: "weight", isIndividualCook: false },
  { category: "Beef", name: "Top Round Roast", targetTempF: 135, cookTempF: 250, minsPerLb: 25, restMins: 20, cookMethod: "Indirect", notes: "Lean cut; smoke to 130–135°F and slice thin across the grain", avgPieceWeightLbs: 4.0, defaultSizeMode: "weight", isIndividualCook: false },
  { category: "Beef", name: "Bottom Round Roast", targetTempF: 145, cookTempF: 250, minsPerLb: 30, restMins: 20, cookMethod: "Low & Slow", notes: "Very lean; slice thin against the grain or shave for sandwich meat", avgPieceWeightLbs: 4.0, defaultSizeMode: "weight", isIndividualCook: false },
  { category: "Beef", name: "Eye of Round Roast", targetTempF: 135, cookTempF: 225, minsPerLb: 25, restMins: 15, cookMethod: "Indirect", notes: "The leanest beef roast; smoke low and slice paper-thin against the grain", avgPieceWeightLbs: 3.0, defaultSizeMode: "weight", isIndividualCook: false },
  { category: "Beef", name: "Bavette Steak (Sirloin Flap)", targetTempF: 130, cookTempF: 450, minsPerLb: 8, restMins: 8, cookMethod: "Direct Heat", notes: "Coarse grain — marinate and always slice against the grain", avgPieceWeightLbs: 1.5, defaultSizeMode: "count", isIndividualCook: true },
  { category: "Beef", name: "Beef Kabobs", targetTempF: 145, cookTempF: 400, minsPerLb: 12, restMins: 3, cookMethod: "Direct Heat", notes: "1.5\" cubes; leave space between pieces on the skewer for even browning", avgPieceWeightLbs: 0.25, defaultSizeMode: "count", isIndividualCook: true },
  { category: "Beef", name: "Carne Asada", targetTempF: 130, cookTempF: 500, minsPerLb: 6, restMins: 5, cookMethod: "Direct Heat", notes: "Thin-sliced beef over screaming-hot grates; done in minutes — always slice against the grain", avgPieceWeightLbs: 0.5, defaultSizeMode: "count", isIndividualCook: true },

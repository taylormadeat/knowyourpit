    ...
    brands: [
      ...
      },
      {
        ...
        models: [
          ...
          { name: "Champion", type: "Pellet Vertical Smoker", fuelType: "Pellets", tempRange: "150°F – 420°F", cookingSurface: "1513 sq in", features: ["5-series vertical cabinet", "Slide-plate flame broiler", "PID controller", "Four porcelain-coated racks", "Meat probe included", "Large 60 lb hopper"], notes: "Pit Boss's flagship vertical pellet smoker — competition-grade capacity for serious pitmasters" },

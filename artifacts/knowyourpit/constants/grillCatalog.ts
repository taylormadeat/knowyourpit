        ...
        models: [
          {
            ...
            features: ["Fits inside 22\" Weber kettle", "WiFi + Bluetooth app control", "Auto fan temperature regulation", "Easy pellet hopper load", "Works with existing kettle lid"],
            notes: "Converts a standard 22\" kettle into a WiFi-controlled pellet smoker",
          },
          {
            name: "Venom Plus",
            type: "Pellet Grill",
            ...
            features: ["Fits 26\" Weber kettle", "WiFi + Bluetooth", "Larger hopper capacity", "Auto fan temp control", "App monitoring"],
            notes: "Bigger brother to the Venom — designed for 26\" kettles",
          },
          {
            name: "Huntress",
            type: "Cabinet Smoker",
            fuelType: "Pellets",
            tempRange: "180°F – 450°F",
            cookingSurface: "784 sq in",
            features: ["Vertical cabinet design", "WiFi + Bluetooth", "Four cooking racks", "Insulated double-wall", "App-controlled"],
          },
          {
            name: "Monarch",
            type: "Pellet Grill",
            ...
            features: ["Standalone barrel design", "WiFi + Bluetooth", "PID temperature control", "App monitoring", "Large hopper"],
          },
        ],
      },
    ],

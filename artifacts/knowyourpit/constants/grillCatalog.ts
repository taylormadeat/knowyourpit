    ...
    brands: [
      ...
      },
      {
        ...
        models: [
          ...
          { name: "Original PK", type: "Charcoal Grill", fuelType: "Charcoal", tempRange: "200°F – 600°F", cookingSurface: "250 sq in", features: ["Cast aluminum", "Four-vent system", "Durable for decades"] },
        ],
      },
    ],
  },

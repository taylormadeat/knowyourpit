    ...
    brands: [
      ...
      },
      {
        ...
        models: [
          ...
          { name: "KC Combo", type: "Combo", fuelType: "Pellets + Propane", tempRange: "180°F – 500°F", cookingSurface: "1432 sq in", features: ["3-burner gas griddle", "Pellet smoker chamber", "Slide-plate flame broiler", "Dual-zone cooking"], notes: "Best of both worlds — smoke low-and-slow while searing on gas" },
          { name: "Memphis Ultimate 4-in-1", type: "Combo", fuelType: "Combination", tempRange: "200°F – 600°F", cookingSurface: "1410 sq in", features: ["Pellet, charcoal, gas, & griddle in one", "PID controller", "Slide-plate flame broiler"] },
        ],
      },
      {
      ...
      },
      {
        ...
        models: [
          ...
          { name: "Apex 30", type: "Combo", fuelType: "Combination", tempRange: "160°F – 900°F", cookingSurface: "811 sq in", features: ["Pellet smoker + gas grill", "Glass-front flat-top griddle", "WiFi+BT"] },
        ],
      },
      {
        brand: "Weber",
    ...
    brands: [
      ...
      },
      {
        ...
        models: [
          ...
          { name: "Classic Joe Series II Limited", type: "Kamado", fuelType: "Charcoal", tempRange: "225°F – 750°F", cookingSurface: "256 sq in", features: ["Stainless top vent", "Premium accessories pack", "Divide & Conquer"] },
          ...
          { name: "Konnected Big Joe", type: "Kamado", fuelType: "Charcoal", tempRange: "225°F – 750°F", cookingSurface: "452 sq in", features: ["Auto-ignition", "WiFi+BT", "Automated fan control"] },
          { name: "Pro Joe", type: "Kamado", fuelType: "Charcoal", tempRange: "225°F – 750°F", cookingSurface: "604 sq in", features: ["24\" cooking surface", "Heavy-duty cart", "Premium ceramics"], notes: "Largest Kamado Joe — built for catering scale" },
        ],
      },
      {
        brand: "Primo",
      ...
      },
      {
        ...
        models: [
          ...
          { name: "Kamander", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 700°F", cookingSurface: "447 sq in", features: ["Insulated steel construction", "8-position damper", "Cast-iron grates"] },
        ],
      },
      {
        brand: "Vision Grills",
        ...
        models: [
          { name: "Classic B Series", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 700°F", cookingSurface: "596 sq in", features: ["Ceramic body", "Two-tier cooking surface", "Lava Stone deflectors"] },
          { name: "Pro C Series", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 700°F", cookingSurface: "596 sq in", features: ["Stainless steel hardware", "Two-tier grates", "Includes plate setter"] },
          { name: "Pro S Series", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 700°F", cookingSurface: "596 sq in", features: ["Stainless cart", "Multi-zone cooking", "Lava stone deflectors"] },
        ],
      },
      {
        brand: "Saffire",
        models: [
          { name: "Saffire 19\"", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 750°F", cookingSurface: "284 sq in", features: ["Cast iron damper top", "Patented Air Hinge", "Split top design"] },
          { name: "Saffire 23\"", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 750°F", cookingSurface: "414 sq in", features: ["Cast iron damper", "Heavy ceramics", "Split top"] },
        ],
      },
      {
        brand: "Grill Dome",
        models: [
          { name: "Infinity Small", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 750°F", cookingSurface: "176 sq in", features: ["Heavy ceramics", "Cast iron top vent", "Lifetime ceramic warranty"] },
          { name: "Infinity Large", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 750°F", cookingSurface: "318 sq in", features: ["Heavy ceramics", "Cast iron top vent", "Two-tier rack"] },
          { name: "Infinity XL", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 750°F", cookingSurface: "452 sq in", features: ["Largest Grill Dome", "Heavy ceramic body", "Multi-level cooking"] },
        ],
      },
      {
        brand: "Blaze",
        ...
        models: [
          { name: "Kamado 20\"", type: "Kamado", fuelType: "Charcoal", tempRange: "200°F – 750°F", cookingSurface: "365 sq in", features: ["Cast aluminum top vent", "Heavy ceramic body", "Stainless steel cart"] },
        ],
      },
      {
        brand: "Komodo Kamado",
        ...
        models: [
          { name: "23\" Ultimate", type: "Kamado", fuelType: "Charcoal", tempRange: "175°F – 1000°F", cookingSurface: "415 sq in", features: ["Tile-clad ceramic body", "Premium gaskets", "Lifetime warranty"], notes: "Boutique high-end kamado" },
          { name: "32\" BB", type: "Kamado", fuelType: "Charcoal", tempRange: "175°F – 1000°F", cookingSurface: "804 sq in", features: ["Massive ceramic body", "Industrial hinges", "Multi-tier cooking"] },
        ],
      },
    ],
  },
    ...
    brands: [
      {
        ...
        models: [
          ...
          { name: "Highland Reverse Flow", type: "Reverse Flow Smoker", fuelType: "Wood/Charcoal", tempRange: "200°F – 350°F", cookingSurface: "879 sq in", features: ["Optional reverse-flow plates", "Removable smokestack", "Heavy steel"] },
          ...
          { name: "Longhorn Reverse Flow", type: "Reverse Flow Smoker", fuelType: "Wood/Charcoal", tempRange: "200°F – 350°F", cookingSurface: "1060 sq in", features: ["Reverse flow plates", "Optional offset", "Heavy steel"] },
      ...
      },
      {
        ...
        models: [
          ...
          { name: "Durango 24", type: "Cabinet Smoker", fuelType: "Wood/Charcoal", tempRange: "150°F – 400°F", cookingSurface: "1320 sq in", features: ["Vertical cabinet style", "Insulated", "Side firebox"] },
        ],
      },
      {
      ...
      },
      {
        ...
        models: [
          ...
          { name: "20\" RD Special", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 350°F", cookingSurface: "710 sq in", features: ["True reverse flow", "Heavy steel", "Made in USA"] },
    ...
    brands: [
      ...
      },
      {
        ...
        models: [
          ...
          { name: "Charcoal Professional", type: "Kettle", fuelType: "Charcoal", tempRange: "300°F – 700°F", cookingSurface: "510 sq in", features: ["Cast-iron grates", "Adjustable charcoal tray", "Side prep tables"] },
        ],
      },
      {
        brand: "PK Grills",
    ...
    brands: [
      {
        ...
        models: [
          { name: "BBQ42", type: "Reverse Flow Smoker", fuelType: "Wood/Charcoal", tempRange: "200°F – 350°F", cookingSurface: "672 sq in", features: ["True reverse flow", "Slide-out charcoal tray", "Grease drain"] },
          { name: "SQ36", type: "Reverse Flow Smoker", fuelType: "Wood/Charcoal", tempRange: "200°F – 350°F", cookingSurface: "900 sq in", features: ["Square box reverse flow", "Charcoal pan", "Competition grade"] },
          { name: "TS70", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 300°F", cookingSurface: "1500 sq in", features: ["Trailer-mountable", "Reverse flow", "Heavy steel"] },
          { name: "TS250", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 300°F", cookingSurface: "2500 sq in", features: ["Trailer mounted", "True reverse flow", "Massive capacity"] },
        ],
      },
      {
        brand: "Char-Griller",
        logoUrl: "https://logo.clearbit.com/chargriller.com",
        models: [
          { name: "Grand Champ XD", type: "Reverse Flow Smoker", fuelType: "Wood/Charcoal", tempRange: "200°F – 350°F", cookingSurface: "1260 sq in", features: ["Reverse flow baffle", "Barrel design", "Side firebox"] },
          ...
          { name: "Competition Pro Offset", type: "Reverse Flow Smoker", fuelType: "Wood/Charcoal", tempRange: "200°F – 350°F", cookingSurface: "830 sq in", features: ["Reverse flow plates", "Side firebox", "Wagon wheels"] },
        ],
      },
      {
        brand: "Lone Star Grillz",
        models: [
          { name: "20\" x 42\"", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 350°F", cookingSurface: "840 sq in", features: ["1/4\" steel", "True reverse flow", "Custom-built to order"] },
          { name: "24\" x 48\"", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 350°F", cookingSurface: "1152 sq in", features: ["1/4\" steel", "True reverse flow", "Large capacity"] },
      ...
      },
      {
        ...
        logoUrl: "https://logo.clearbit.com/workhorsepits.com",
        models: [
          { name: "1957 Reverse Flow", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 350°F", cookingSurface: "1100 sq in", features: ["True reverse flow plates", "Counterweight lid", "1/4\" steel"], notes: "Reverse flow version of the 1969 stick burner" },
        ],
      },
      {
        brand: "Shirley Fabrication",
        models: [
          { name: "24\" x 50\" Patio Smoker", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 350°F", cookingSurface: "1200 sq in", features: ["1/4\" American steel", "Custom Alabama-built", "Counterweight lid"], notes: "Highly regarded competition smoker" },
          { name: "32\" x 60\" Trailer Smoker", type: "Reverse Flow Smoker", fuelType: "Wood", tempRange: "200°F – 350°F", cookingSurface: "1900 sq in", features: ["Trailer mounted", "Heavy steel build", "Hand-built"] },
        ],
      },
    ],
  },

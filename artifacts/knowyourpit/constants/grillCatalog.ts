...

  {
    ...
    brands: [
      ...
      },
      {
        ...
        models: [
          {
            name: "Venom (Kamado Insert)",
            type: "Kamado",
            fuelType: "Charcoal",
            tempRange: "225°F – 500°F",
            cookingSurface: "254 sq in",
            features: ["Fits inside Big Green Egg Large & similar kamados", "WiFi + Bluetooth app control", "Auto fan temperature regulation", "Pellet hopper insert", "Works with existing kamado dome"],
            notes: "Turns your kamado into a set-it-and-forget-it WiFi smoker",
          },
          {
            name: "Venom Plus (Kamado Insert)",
            type: "Kamado",
            fuelType: "Charcoal",
            tempRange: "225°F – 500°F",
            cookingSurface: "452 sq in",
            features: ["Fits XL kamados", "WiFi + Bluetooth", "Larger hopper capacity", "Auto fan temp control", "App monitoring"],
            notes: "Designed for XL & Big Joe sized kamados",
          },
        ],
      },
    ],
        ...
        models: [
          {
            ...
            fuelType: "Charcoal",
            tempRange: "225°F – 500°F",
            cookingSurface: "363 sq in",
            features: ["Fits inside standard 22\" kettle grills", "WiFi + Bluetooth app control", "Auto fan temperature regulation", "Drop-in pellet hopper", "Uses your existing kettle lid"],
            notes: "Converts any 22\" charcoal kettle into a WiFi-controlled smoker",
          },
          {
            name: "Venom Plus",
            type: "Kettle",
            fuelType: "Charcoal",
            tempRange: "225°F – 500°F",
            cookingSurface: "508 sq in",
            features: ["Fits 26\" kettle grills", "WiFi + Bluetooth", "Larger hopper capacity", "Auto fan temp control", "App monitoring & alerts"],
            notes: "Bigger version for 26\" kettles with more cooking space",
          },
        ],
      },
    ],

...
export const s = StyleSheet.create({
  ...
  probePlaceholder: { borderTopWidth: 1, flexDirection: "row", alignItems: "center", gap: 10, padding: 16 },
  probePlaceholderText: { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 19 },
  planSheetOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "flex-end" },
  planSheet: { borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: "85%" },
  planSheetHandle: { width: 36, height: 4, borderRadius: 2, alignSelf: "center", marginTop: 10, marginBottom: 14 },
  planSheetHeader: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 16, paddingBottom: 14, borderBottomWidth: 1, marginBottom: 4 },
  planSheetTitle: { flex: 1, fontSize: 16, fontFamily: "Inter_700Bold" },
  planSheetClose: { padding: 2 },
  planGrid: { paddingHorizontal: 0 },
  planGridRow: { flexDirection: "row", borderTopWidth: 1 },
  planGridCell: { flex: 1, padding: 14, borderRightWidth: 1 },
  planGridCellFull: { padding: 14, borderTopWidth: 1 },
  ...
  probeTempsRow: { flexDirection: "row", gap: 10, flexWrap: "wrap" },
  probeTempChip: { flexDirection: "row", alignItems: "center", gap: 8, flex: 1, minWidth: 90 },
  probeTempValue: { fontSize: 18, fontFamily: "Inter_700Bold" },
  probeTempLabel: { fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 1 },
  probeAutoFillBadge: { flexDirection: "row", alignItems: "center", gap: 6, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, marginTop: 8 },
  probeAutoFillText: { fontSize: 12, fontFamily: "Inter_500Medium", flex: 1 },
